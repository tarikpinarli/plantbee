            ...
            <section className="rounded-3xl border border-stone-200 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
                ...
                {isLoading ? (
                    ...
                    <div className="rounded-2xl border border-red-100 bg-red-50/50 p-6 text-red-700">
                        <p className="font-medium">Communication Error</p>
                        <p className="mt-1 text-sm bg-red-100/50 p-2 rounded-lg font-mono">
                            {error instanceof Error ? error.message : 'Unknown error'}
                        </p>
                        <p className="mt-3 text-sm text-red-600">
                            This usually happens if the backend container doesn't have the new routes yet.
                            <strong> Please run:</strong> <code className="bg-red-100 px-1 rounded">docker-compose up --build app</code> to force a backend rebuild.
                        </p>
                    </div>
                ) : data ? (
